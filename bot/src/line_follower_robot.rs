    ...
    impl ::core::fmt::Debug for DeviceOperation {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                DeviceOperation::ReadAccel => f.debug_tuple("DeviceOperation::ReadAccel").finish(),
                DeviceOperation::ReadGyro => f.debug_tuple("DeviceOperation::ReadGyro").finish(),
                DeviceOperation::ReadImuFusedData => {
                    f.debug_tuple("DeviceOperation::ReadImuFusedData").finish()
                }
                DeviceOperation::GetTime => f.debug_tuple("DeviceOperation::GetTime").finish(),
                DeviceOperation::SleepFor(e) => {
                    f.debug_tuple("DeviceOperation::SleepFor").field(e).finish()
                }
                DeviceOperation::SleepUntil(e) => f
                    .debug_tuple("DeviceOperation::SleepUntil")
                    .field(e)
                    .finish(),
    ...
    impl ::core::fmt::Debug for PollOperationStatus {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                PollOperationStatus::Ready(e) => f
                    .debug_tuple("PollOperationStatus::Ready")
                    .field(e)
                    .finish(),
            }
        }
    ...
    impl ::core::fmt::Debug for ValueKind {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                ValueKind::Named(e) => f.debug_tuple("ValueKind::Named").field(e).finish(),
                            ...
                            match kind2 {
                                ...
                                ValueKind::Named(e) => {
                                    *base
                                    ...
                                    .unwrap();
                                    let (result6, _cleanup6) =
                                        wit_bindgen::rt::Cleanup::new(layout6);
    ...
    pub mod robot {
        ...
        pub unsafe fn _export_setup_cabi<T: Guest>() -> *mut u8 {
            unsafe {
                ...
                *ptr1
                    .add(2 * ::core::mem::size_of::<*const u8>())
                    .cast::<u8>() = (_rt::as_i32(r4)) as u8;
                *ptr1
                    .add(1 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<u8>() = (_rt::as_i32(g4)) as u8;
                *ptr1
                    .add(2 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<u8>() = (_rt::as_i32(b4)) as u8;
                let Color {
                    r: r5,
                    g: g5,
                    b: b5,
                ...
                *ptr1
                    ...
                    .cast::<u8>() = (_rt::as_i32(r5)) as u8;
                *ptr1
                    .add(4 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<u8>() = (_rt::as_i32(g5)) as u8;
                *ptr1
                    .add(5 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<u8>() = (_rt::as_i32(b5)) as u8;
                *ptr1
                    .add(8 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<f32>() = _rt::as_f32(width_axle2);
                *ptr1
                    .add(12 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<f32>() = _rt::as_f32(length_front2);
                *ptr1
                    .add(16 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<f32>() = _rt::as_f32(length_back2);
                *ptr1
                    .add(20 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<f32>() = _rt::as_f32(clearing_back2);
                *ptr1
                    .add(24 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<f32>() = _rt::as_f32(wheel_diameter2);
                *ptr1
                    .add(28 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<i32>() = _rt::as_i32(gear_ratio_num2);
                *ptr1
                    .add(32 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<i32>() = _rt::as_i32(gear_ratio_den2);
                *ptr1
                    .add(36 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<f32>() = _rt::as_f32(front_sensors_spacing2);
                *ptr1
                    .add(40 + 2 * ::core::mem::size_of::<*const u8>())
                    .cast::<f32>() = _rt::as_f32(front_sensors_height2);
                ptr1
            }
        }
        #[doc(hidden)]
    ...
    unsafe extern "C" fn export_run() {
      unsafe { $($path_to_types)*::_export_run_cabi::<$ty>() }
        ...
        static mut _RET_AREA: _RetArea = _RetArea(
            [::core::mem::MaybeUninit::uninit(); 40 + 3 * ::core::mem::size_of::<*const u8>()],
        );
    }
}
mod _rt {
...
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1328] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa6\x09\x01A\x02\x01\
A\x06\x01B\x18\x01y\x04\0\x07time-us\x03\0\0\x01r\x02\x02idy\x08ready-at\x01\x04\
...
tion\x07\0\x05\x04\0\x19device-operation-blocking\x01\x0c\x01@\x01\x09operation\x07\
