...
pub mod devices {
    ...
    impl PollError {
        ...
        pub fn message(&self) -> &'static str {
            match self {
                PollError::InvalidHandle => {
                    "The provided handle is not valid
        (this handle has never been created)"
                }
                PollError::ConsumedHandle => {
                    "The provided handle has already been consumed
        (the detection of this case is best-effort,
        otherwise the handle is reported as expired)"
                }
                PollError::ExpiredHandle => {
                    "The provided handle is too old and its value has been lost
        (more recent values are available and replace the old one)"
                }
            }
    ...
    impl PollError {
        #[doc(hidden)]
        pub unsafe fn _lift(val: u8) -> PollError {
            if !cfg!(debug_assertions) {
                return ::core::mem::transmute(val);
            }
            match val {
                0 => PollError::InvalidHandle,
                1 => PollError::ConsumedHandle,
                2 => PollError::ExpiredHandle,
    ...
    pub fn device_operation_blocking(operation: DeviceOperation) -> DeviceValue {
        unsafe {
            ...
            let (result0_0, result0_1) = match operation {
                ...
                DeviceOperation::ReadMotorAngles => (2i32, 0i32),
                DeviceOperation::ReadAccel => (3i32, 0i32),
                DeviceOperation::ReadGyro => (4i32, 0i32),
                DeviceOperation::ReadImuFusedData => (5i32, 0i32),
                DeviceOperation::GetTime => (6i32, 0i32),
                DeviceOperation::SleepFor(e) => (7i32, _rt::as_i32(e)),
                DeviceOperation::SleepUntil(e) => (8i32, _rt::as_i32(e)),
                DeviceOperation::GetEnabled => (9i32, 0i32),
    ...
    pub fn device_poll(handle: FutureHandle) -> Result<PollOperationStatus, PollError> {
        unsafe {
            #[repr(align(1))]
...
pub mod diagnostics {
    ...
    impl ::core::fmt::Debug for ValueKind {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ValueKind::Int8 => f.debug_tuple("ValueKind::Int8").finish(),
                ValueKind::Int16 => f.debug_tuple("ValueKind::Int16").finish(),
                ValueKind::Int32 => f.debug_tuple("ValueKind::Int32").finish(),
                ValueKind::Uint8 => f.debug_tuple("ValueKind::Uint8").finish(),
                ValueKind::Uint16 => f.debug_tuple("ValueKind::Uint16").finish(),
                ValueKind::Uint32 => f.debug_tuple("ValueKind::Uint32").finish(),
                ValueKind::Named(e) => {
                    f.debug_tuple("ValueKind::Named").field(e).finish()
                }
                ValueKind::Pad8 => f.debug_tuple("ValueKind::Pad8").finish(),
                ValueKind::Pad16 => f.debug_tuple("ValueKind::Pad16").finish(),
            }
        }
    }
            ...
            let (result8_0, result8_1, result8_2) = match csv {
                Some(e) => {
                    ...
                    let layout7 = _rt::alloc::Layout::from_size_align_unchecked(
                        vec7.len() * (5 * ::core::mem::size_of::<*const u8>()),
    ...
    pub mod robot {
        ...
        impl ::core::fmt::Debug for Configuration {
            fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                f.debug_struct("Configuration")
                    ...
                    .field("wheel-diameter", &self.wheel_diameter)
        ...
        pub unsafe fn _export_setup_cabi<T: Guest>() -> *mut u8 {
            ...
            let Configuration {
                ...
                wheel_diameter: wheel_diameter2,
            ...
            *ptr1.add(8 + 2 * ::core::mem::size_of::<*const u8>()).cast::<f32>() = _rt::as_f32(
                width_axle2,
            );
            *ptr1.add(12 + 2 * ::core::mem::size_of::<*const u8>()).cast::<f32>() = _rt::as_f32(
                length_front2,
            );
            *ptr1.add(16 + 2 * ::core::mem::size_of::<*const u8>()).cast::<f32>() = _rt::as_f32(
                length_back2,
            );
            *ptr1.add(20 + 2 * ::core::mem::size_of::<*const u8>()).cast::<f32>() = _rt::as_f32(
                clearing_back2,
            );
            *ptr1.add(24 + 2 * ::core::mem::size_of::<*const u8>()).cast::<f32>() = _rt::as_f32(
                wheel_diameter2,
            );
            ...
            *ptr1.add(36 + 2 * ::core::mem::size_of::<*const u8>()).cast::<f32>() = _rt::as_f32(
                front_sensors_spacing2,
            );
            *ptr1.add(40 + 2 * ::core::mem::size_of::<*const u8>()).cast::<f32>() = _rt::as_f32(
